...
class Rpt_Info {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Rpt_Info_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Rpt_Info_Loader. Orchestrates the hooks of the plugin.
	 * - Rpt_Info_i18n. Defines internationalization functionality.
	 * - Rpt_Info_Admin. Defines all hooks for the admin area.
	 * - Rpt_Info_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rpt-info-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-rpt-info-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-rpt-info-admin.php';
	 ...
	 *
	 * Uses the Rpt_Info_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Rpt_Info_Loader    Orchestrates the hooks of the plugin.
	 */
